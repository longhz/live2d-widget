...
你可以直接这样使用：
```xml
<script src="https://cdn.jsdelivr.net/gh/longz/live2d-widget/autoload.js"></script>
```
...
git clone https://github.com/longz/live2d-widget.git
```
...
waifu-tips.js找到配置项目
// 默认模型
live2d_settings['modelId']              = 1;            // 默认模型 ID，可在 F12 控制台Network找到
live2d_settings['modelTexturesId']      = 53;           // 默认材质 ID，可在 F12 控制台Network找到

id=1 蝙蝠女1   modid（'79',‘16’，‘47’，‘18’，‘48’，‘41’，‘86’,'78'）
id=2 蝙蝠女仆2 modid（‘27’，‘28’，‘’）
id=3 22 modid 82 143 9 121 141 127 28 111 	
id=4 33 modid ('129','100','51','139','134','89','152','120','103','130','113','96','99','82','48','8','12','127','38','104')
id=5 学生  modid 2 
